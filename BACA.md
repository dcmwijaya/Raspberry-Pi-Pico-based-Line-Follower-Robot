...
| Komponen Lainnya | Kabel mikro usb (x1), Kabel jumper, Baterai Li-ion 18650 (x2), Tempat baterai seri 2 slot (x1), Roda robot (x2), Roda kastor (x1), Motor driver L298N (x1), Kerangka robot mobil (x1), Soket konektor mikro usb jantan (x1), DLL |
