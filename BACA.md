...
4. Kemudian cari berkas yang bernama ``` rpipico_line_follower.py ``` di komputer Anda -> lalu ubah nama berkasnya menjadi: ``` main.py ``` agar nantinya dapat dikenali oleh Raspberry Pi Pico ketika ingin dioperasikan.<br><br>
